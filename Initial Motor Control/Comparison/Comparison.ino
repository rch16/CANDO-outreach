// Code for comparing the 3 motors models in order to select the most suitable
// Based on S-curve.ino

// Motor 1: Sanyo Denki SM2863-5151
// Motor 2: Astrosyn MY34H1-3
// Motor 3: Stepper Online 34HS38-3008S
...
const int minspeed = 2500;   // delay, not speed
int maxspeed = 1000;
int motorSpeed = 0;
